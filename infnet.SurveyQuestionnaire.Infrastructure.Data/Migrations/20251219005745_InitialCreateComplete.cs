        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectionStart = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CollectionEnd = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Submissions_Users_RespondentUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubmissionItems_Options_SelectedOptionId",
                        column: x => x.SelectedOptionId,
                        principalTable: "Options",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SubmissionItems_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubmissionItems_QuestionId",
                table: "SubmissionItems",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_SubmissionItems_SelectedOptionId",
                table: "SubmissionItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_QuestionnaireId_RespondentUserId",
                table: "Submissions",
                columns: new[] { "QuestionnaireId", "RespondentUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Submissions_RespondentUserId",
                table: "Submissions",
